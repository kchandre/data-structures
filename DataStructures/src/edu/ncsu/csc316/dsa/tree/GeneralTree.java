...
/**
 * Creates and defines behaviors and methods for a general tree
 * 
...
public class GeneralTree<E> extends AbstractTree<E> implements GeneralTreeCollection<E> {
	...
	/**
	 * Creates new general tree object with null root and size zero
	 */
	public GeneralTree() {
		root = null;
		size = 0;
	...
	/**
	 * Creates and defines behaviors and methods of a general tree node
	 * 
	 * @author Gianna Mastrandrea
	 *
	 * @param <E> generic object
